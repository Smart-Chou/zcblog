---
title: 隐私政策
description: 协议最新更新时间为：2025-06-17
---

本站非常重视用户的隐私和个人信息保护。你在使用网站时，可能会收集和使用你的相关信息。通过《隐私政策》向你说明在你访问 marxchou.com 网站时，如何收集、使用、保存、共享和转让这些信息。
...
**在访问时，本人仅会处于以下的目的，使用你的个人信息：**

在访问时，站内置的第三方服务会通过以下或更多途径，来获取你的以下或更多信息：

- **Vercel** 会收集你的访问信息，用于提供网站托管与加速服务。
- **Umami** 会收集你的访问信息，用于网站访问统计分析。
...
**在评论时，站内置的第三方服务会通过以下或更多途径，来获取你的相关信息：**
...
本站为实现无账号评论、深色模式切换、Umami 访问统计等功能，会在你的浏览器中进行本地存储，你可以随时清除浏览器中保存的所有 Cookies 以及 LocalStorage，不影响你的正常使用。
