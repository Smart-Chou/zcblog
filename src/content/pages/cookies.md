---
title: Cookies
description: 本政策的最近更新日期为：2024-10-25
---
...
如果你对我使用你的个人信息或 Cookies 的方式有任何疑问，请通过 qlad_adgk@163.com 与我联系。
...
有关 Cookies 以及如何管理 Cookies 的更多信息，请访问：[wikipedia.org](https://zh.wikipedia.org/wiki/Cookie)、[allaboutCookies.org](https://www.allaboutcookies.org/) 或 [aboutCookies.org](https://www.aboutcookies.org/)。

## 更多信息

有关我数据处理的更多信息，请参阅我的 [隐私政策](/privacy-policy)。如果你对此 Cookie 政策有任何疑问，请通过 qlad_adgk@163.com 与我联系。
